...
def google_account(identity):
    ...
    if client_secret_json_file or (client_id and client_secret):
        QuickLog.log("Successfully get client_file/client_secret.")
    ...
    QuickLog.log("Google Account initiated.")
...
def outlook_account(identity):
    ...
    QuickLog.log("Outlook Account initiated.")
...
def pass_account(identity):
    ...
    QuickLog.log("Pass Account initiated.")
    return pass_mailbox
